...
目前以个人简介、研究方向和代表成果展示为主。论文前六篇直接展示，其余在折叠区；顺序表示展示优先级，并非自动按年份排序。有实际内容后再增加动态、教学和学生指导栏目。

设计参考：[方双康](https://sk-fun.fun/)、[刘天润](https://trliu-hhu.github.io/)；长期栏目组织参考：[谢再鹏](https://zach82.github.io/)。参考链接不代表取得其代码或图片的再使用许可。
